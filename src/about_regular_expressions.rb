...
class AboutRegularExpressions < Neo::Koan
  ...
  # Why?
  #
  # repetition is greedy by default it is much better to use 
  # lazy matching that makes the minimal amount of matches necessary
  ...
  # instead the alternatives allow for more general choices.
  # ------------------------------------------------------------------
