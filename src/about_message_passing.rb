...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # THINK ABOUT IT:
    #
    # maybe because "send" could be used by another method
    # or class because is a very common name instead
    # "__send__" that isn't common
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # will no longer cause the exception
    #
    # NOTE:
    #
