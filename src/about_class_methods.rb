...
class AboutClassMethods < Neo::Koan
  ...
  # I prefer the first because it allows you to recognize
  # the class name and when you need to know which method 
  #you want to call I recognize that quickly instead the 
  #second method is misleading because that method needs a double 
  #"definition" as can be seen above.
