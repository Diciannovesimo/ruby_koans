...
class AboutVariableScope < Neo::Koan
  ...
  # the instance variable is class-independent and can change value, 
  # the class variable is a variable that belongs to the class, 
  # whose value is common to all instances 
  # ------------------------------------------------------
